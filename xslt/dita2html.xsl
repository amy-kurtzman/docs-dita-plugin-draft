...
<head>
	...
	<title>
		...
		<xsl:value-of select="concat($topic.title, ' — ', $input.map/map/title)"></xsl:value-of>
	</title>
...
<body data-modules="developer-portal-sidebar-navigation developer-portal-versions-navigation">
	...
	<div class="layout-wrapper">
		<div class="developer-portal-header__hgroup">
			...
			<p class="developer-portal-header__page-title"><xsl:value-of select="$input.map/map/title" /></p>
			<!--<xsl:choose>
